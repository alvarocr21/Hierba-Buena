...
class Perfil(db.Model):
    ...
    foto_perfil = db.Column(db.String(20), unique=False, nullable=False)
    coordenadas = db.Column(db.String(20), unique=False, nullable=False)
...
class Producto(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(20), unique=False, nullable=False)
    photo = db.Column(db.String(20), unique=False, nullable=False)
    perfil_producto = db.relationship('Perfil_Producto', lazy=True)
